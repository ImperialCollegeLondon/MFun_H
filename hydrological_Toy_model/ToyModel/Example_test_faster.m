...
clear all
%addpath(genpath('C:\Users\ap307\Documents\PHD_organised\Tools\topotool'))
addpath(genpath('C:\Users\ap307\Documents\PHD_organised\Tools\TOMMAT'))
load DTM_V11;
%load dtm_CX_domain;
T = T_flow2;
%T = T_flow;
...
%%% Precipitation
load('C:\Users\ap307\Documents\PHD_organised\Tools\from_simone\rainfall_matlab\Fir_Xim_1090_5min')
% Prt=sum(buffer(V,12)); %%% [mm/h]
Prt=aggregate(V,12,'sum'); %%% [mm/h]
Prt=Prt(1:end);
Prt(~isfinite(Prt)) = 0;
