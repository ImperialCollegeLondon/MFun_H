...
%
% Example:
% xyz=ascii2xyz('./PlynlimonCat35m.asc');
% save PlynlimonCat35m_xyz.txt xyz -ascii
% 
% 
% clear;clc
% fp = ['C:\Users\Yuting Chen\Dropbox (Personal)\MATLAB_CODE_',...
%     'RRMODEL_0319\MATLAB_CODE_RRMODEL\ImportData\'];
% load([fp,'TERRAIN50_EA.mat']);
% xyz = [xx(:),yy(:),disz(:)];
% save EastAngliaCat_xyz.txt xyz -ascii
% 
% 
